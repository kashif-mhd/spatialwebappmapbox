          ...
          <div className="grid gap-4">
            ...
            <Tabs defaultValue="account" className="w-full">
              ...
              <TabsContent value="account">
                <Card className="p-3">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Velit voluptatum sapiente error sunt aut
                  exercitationem enim similique, est cumque dolore voluptas sed iste autem a et soluta fugiat maxime
                  odit?
                </Card>
              </TabsContent>
